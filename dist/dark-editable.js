...
class h {
  ...
  ajax(t) {
    ...
    if (s.append("id", this.context.options.id), s.append("name", this.context.options.name), s.append("value", t), ((i = this.context.options.ajaxOptions) == null ? void 0 : i.method) === "GET") {
      const c = [];
      s.forEach((p, d) => {
        c.push(`${d}=${p}`);
      }), e += "?" + c.join("&");
